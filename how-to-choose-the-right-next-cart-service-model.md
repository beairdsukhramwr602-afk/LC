...
If the project requires customization, modification, tailored Add-ons, custom Add-ons, Custom Cart handling, migration-tool adjustment, or broader bespoke handling, **Custom Service** is required.
...
| Custom Cart is the Source Cart or Target Cart                                        | Custom Service                                                             |
...
* no Custom Cart or bespoke data handling is involved
...
Demo Migration can make the service decision clearer because it shows how representative source-store data behaves in the Target Cart.
...
A demo result that reveals Add-on limitations, Custom Cart issues, custom fields, app-owned data, or target-platform limitations points toward Custom Service.
...
A smaller migration can still require Custom Service if it involves Custom Cart, modified Add-ons, custom fields, outside-system identifiers, or bespoke transformation.
...
* plan Recent Data Migration if the Source Cart remains active
...
**Scenario 5: Custom Cart is involved**&#x20;

The Source Cart or Target Cart is a Custom Cart and requires interpretation beyond the supported-cart model.
...
Use this article as the final service-choice checkpoint after reviewing the rest of Section 4. If Demo Migration results, Add-on needs, Custom Cart involvement, custom fields, third-party data, or internal execution capacity still feel unclear, Live Chat can help confirm whether Standard Service, Managed Service, or Custom Service is the safest path.
...
Custom Service is required when the project needs customization or modification work, including tailored Add-ons, custom Add-ons, migration tool adjustment, Custom Cart handling, custom fields, third-party data, or other bespoke requirements.
...
Yes. A smaller migration can require Custom Service if it involves Custom Cart, modified Add-ons, custom Add-ons, custom fields, third-party data, or bespoke migration behavior.
...
Review the Demo Migration result, Add-on needs, internal execution capacity, Custom Cart involvement, and custom data requirements. Live Chat can help clarify the safest service path.
